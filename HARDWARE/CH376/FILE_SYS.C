...
UINT8	CH376ByteLocate( unsigned long offset )  /* 以字节为单位移动当前文件指针 */
{
	UINT32 offset_tmp = (UINT32)offset;
	xWriteCH376Cmd( CMD4H_BYTE_LOCATE );
	xWriteCH376Data( (UINT8)offset_tmp );
	xWriteCH376Data( (UINT8)((UINT16)offset_tmp>>8) );
	xWriteCH376Data( (UINT8)(offset_tmp>>16) );
	xWriteCH376Data( (UINT8)(offset_tmp>>24) );
	xEndCH376Cmd( );
	return( Wait376Interrupt( ) );
}
